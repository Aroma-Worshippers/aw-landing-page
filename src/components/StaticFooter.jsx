        ...
        <section className="p-8">
          ...
          <section className="grid grid-cols-1 gap-8 mt-8 text-xl md:grid-cols-2">
            <div>
              ...
              <div className="flex py-2">
                <LuPhone />
                <p className="ml-2">+234 706 846 9754, +234 706 793 3625</p>
              </div>
              <div className="flex py-2">
                <LuInstagram />
                <p className="ml-2 hover:underline">
                  <a
                    href="https://www.instagram.com/aromaworshippers?igsh=MXkxZ2tyZGltNDFlZA=="
                    target="_blank"
                  >
              ...
              <div className="flex py-2">
                ...
                <p className="ml-2 hover:underline">
                  <a
                    href="https://www.facebook.com/share/1GC5cwEqzN/"
                    target="_blank"
                  >
                    @aromaworshippers
                  </a>
            ...
            <div className="p-4">
              ...
              <div className="flex py-2">
                ...
                <p className="ml-2 hover:underline">
                  <a
                    href="https://youtube.com/@godsoracle?si=tYzbECHi8eCmP6Bd"
                    target="_blank"
                  >
                    @godsoracle
                  </a>
