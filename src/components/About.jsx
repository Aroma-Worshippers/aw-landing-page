export default function About() {
    return (
      <>
        <section id="about" className="p-2 m-auto">
          <div className="grid content-center grid-cols-1 p-4 md:grid-cols-2 ">
            <div className="grid gap-4 p-4">
              <div>
                <h2 className="mb-4 text-2xl md:text-4xl font-bold underline uppercase decoration-[#00B425] ">
                  About Us
                </h2>
                <p className="w-full text-lg font-semibold text-justify md:text-xl md:w-3/4">
              ...
              <div>
                ...
                <p className="w-full text-lg font-semibold md:text-xl md:w-3/4">
